...
def dashboard(request, employee_data):
    ...
    return render(request, 'hrm/portal/dashboard.html', context)
...
def profile(request, employee_data):
    ...
    if request.method == 'POST':
        ...
        return redirect('hrm:portal_profile')

    context = {'employee': employee_data}
    return render(request, 'hrm/portal/profile.html', context)
...
def attendance(request, employee_data):
    ...
    return render(request, 'hrm/portal/attendance.html', context)
...
def leave(request, employee_data):
            ...
            try:
                ...
                if emp_obj:
                    ...
                    if balance and balance.available <= 0:
                        ...
                        return redirect('hrm:portal_leave')
    ...
    return render(request, 'hrm/portal/leave.html', context)
...
def payslips(request, employee_data):
    ...
    return render(request, 'hrm/portal/payslips.html', context)
...
def performance(request, employee_data):
    ...
    if request.method == 'POST':
        ...
        return redirect('hrm:portal_performance')
    ...
    return render(request, 'hrm/portal/performance.html', context)
...
def documents(request, employee_data):
    ...
    return render(request, 'hrm/portal/documents.html', context)
...
def training_catalog(request, employee_data):
    ...
    if request.method == 'POST':
        ...
        return redirect('hrm:portal_training_catalog')
    ...
    return render(request, 'hrm/portal/training_catalog.html', context)
...
def development_plans(request, employee_data):
    ...
    if request.method == 'POST':
        ...
        return redirect('hrm:portal_development_plans')
    ...
    return render(request, 'hrm/portal/development_plans.html', context)
...
def notifications(request, employee_data):
    ...
    if request.method == 'POST':
        ...
        return redirect('hrm:portal_notifications')
    ...
    return render(request, 'hrm/portal/notifications.html', context)
...
def succession(request, employee_data):
    ...
    return render(request, 'hrm/portal/succession.html', context)
...
def skills_inventory(request, employee_data):
    ...
    if request.method == 'POST':
        ...
        return redirect('hrm:portal_skills_inventory')
    ...
    return render(request, 'hrm/portal/skills_inventory.html', context)
...
def feedback_360(request, employee_data):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            messages.error(request, f"Error: {e}")
        return redirect('hrm:portal_feedback_360')
    ...
    return render(request, 'hrm/portal/feedback_360.html', context)
...
def surveys(request, employee_data):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            messages.error(request, f"Error: {e}")
        return redirect('hrm:portal_surveys')
    ...
    return render(request, 'hrm/portal/surveys.html', context)
...
def compliance_calendar(request, employee_data):
    ...
    if request.method == 'POST' and emp_obj:
        ...
        try:
            ...
            messages.error(request, f"Error: {e}")
        return redirect('hrm:portal_compliance_calendar')
    ...
    return render(request, 'hrm/portal/compliance_calendar.html', context)
...
def talent_review(request, employee_data):
    ...
    return render(request, 'hrm/portal/talent_review.html', context)
